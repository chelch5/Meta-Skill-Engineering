...
- Tauri desktop launch validation for the operator studio shell
...
- Desktop build validation now runs through the Tauri toolchain
...
- GitHub skill import now clones and validates remote skill packages instead of saving an empty run
